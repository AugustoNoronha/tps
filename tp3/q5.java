...
class Lista {
    ...
    public void heapSort() throws Exception{
        ...
        //alterar o vetor para voltar a pos 0
        tmp = array;
        array = new Games[n];
    ...
    public void construir(int tamheap) throws Exception{

        for(int i = tamheap; i > 1 && array[i].getDate().after(array[i/2].getDate()); i /= 2) {
            
            swap(i, i/2);
        }
    }

    public void reconstruir(int tamheap) throws Exception{
        ...
        while(i <= (tamheap/2)) {
            ...
            if(array[i].getDate().before(array[filho].getDate())) {
    ...
    public int getMaiorFilho(int i, int tamheap) throws Exception{

        int filho;
        
        if(2*i == tamheap || array[2*i].getDate().after(array[2*i+1].getDate())) {
